        ...
        <Stack spacing={12}>
          ...
          <Grid container direction={{ xs: "column", md: "row" }} columnSpacing={{ md: 6 }}>
            ...
            >
              ...
              <Typography variant='subtitle2' mb={{ xs: 2, md: 0 }} color='#092C4C'>
                Share and track your packages via our website and mobile app and monitor your
                Dispatchers journey. Our technology helps put peace of mind at your fingertips.
              </Typography>
            </Grid>
          ...
          <Grid container direction={{ xs: "column-reverse", md: "row" }} columnSpacing={{ md: 6 }}>
            ...
            >
              ...
              <Typography variant='subtitle2' mb={{ xs: 2, md: 0 }} color='#092C4C'>
                After confirming your order, we display our DSpatcher's profile information and bike
                description on the app for you to verify before dropping your package. By doing this
                we help you make sure your goods are in the right hands.
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid container direction={{ xs: "column", md: "row" }} columnSpacing={{ md: 6 }}>
            ...
            >
              ...
              <Typography variant='subtitle2' mb={{ xs: 4, md: 0 }} color='#092C4C'>
                We have partnered with Insurance to insure all your goods with us, therefore any
                complaint with respect to damaged goods, delay in delivery, or missing goods, must
                be directed to DSPatch registered office, phone call, or email address within 3 days
