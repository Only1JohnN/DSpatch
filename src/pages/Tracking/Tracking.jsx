...
const Tracking = () => {
  ...
  return (
    <div>
      <div className='tr-hero container-fluid'>
      ...
      <div className='container'>
        ...
        <div id={!display2 && display ? "tab-indicator" : ""}></div>
        <div id={display2 && display ? "tab-indicator2" : ""}></div>
      ...
      <div className='tr-benefit container mt-5 '>
        ...
        <h1 className='text-center fw-bold mb-5'>Tracking Benefits</h1>
        <div className='container-sm'>
          <div className='row gx-5'>
            <div className='col-lg-6 col-md-12 col-sm-12 tr-benefit__text'>
              ...
              <p>
                ...
                save your shipments directly to our site, eliminating the need to check in to find
                out where your items are.
              </p>
            </div>
            <div className='col-lg-6 col-md-12 col-sm-12 tr-benefit__list'>
              <h3>Key Benefits</h3>
          ...
          <div className='row gx-5'>
            ...
            <div className='col-lg-6 col-md-12 col-sm-12 tr-benefit__text'>
              ...
              <p>
                ...
                while you're on the move so you can remain on top of your shipments 24 hours a day,
                7 days a week(24/7), from any location. It puts all of DSpatch Tracking's power in
